/**
 * Browser public package declarations.
 *
 * Keep this declaration root aligned with `src/browser.js`: the browser-safe
 * package surface is composed from the stable codec, encoder, and browser-safe
 * container subpath barrels, while shared public-only types stay in
 * `public-types.d.ts`.
 */
export type {
  BinaryInput,
